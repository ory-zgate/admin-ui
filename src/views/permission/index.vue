<template>
  <div class="app-container">
    <div class="filter-container">
      <!-- <el-input v-model="listQuery.namespace" placeholder="namespace" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" /> -->
      <el-select v-model="listQuery.namespace" style="width: 140px" class="filter-item" @change="handleFilter">
    ...
    >
      <!-- <el-table-column label="ID" prop="id" align="center" width="380" :class-name="getSortClass('id')">
        <template slot-scope="{row}">
          <span>{{ row.id }}</span>
        </template>
      </el-table-column> -->
      <el-table-column label="namespace" width="210px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.namespace }}</span>
        </template>
      </el-table-column>
      <el-table-column label="object" width="210px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.object }}</span>
        </template>
      </el-table-column>
      <el-table-column label="subject" width="210px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.subject }}</span>
        </template>
      </el-table-column>
      <el-table-column label="relation" width="210px" align="center">
        <template slot-scope="{row}">
  ...
  methods: {
    getList() {
      ...
      fetchList(this.listQuery).then(response => {
        ...
        this.list = response?.relation_tuples
        this.total = 10
